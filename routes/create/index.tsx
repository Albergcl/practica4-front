...
export const handler: Handlers = {
  async POST(_req, ctx) {
    // ERROR: Se estaban utilizando las variables en español, cuando en el formulario se usan en inglés y la API los espera asi
    ...
    try {
      // ERROR: Se estaba usando el metodo patch, pero la api espera el metodo post
