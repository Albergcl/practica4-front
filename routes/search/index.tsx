  ...
  async GET(_req, ctx) {
    try {
      ...
      const { data } = await axios.get<ApiResponseSuccess<Post[]>>(
        // ERROR: el endpoint estaba mal escrito como /api/posts?query=${query} cuando debería ser /api/posts?search=${query}
...
export default function Search({ data }: SearchProps) {
  ...
  // ERROR: El input debe llamarse query porque tiene que coincidir con el nombre del parámetro de búsqueda en la URL
  return (
