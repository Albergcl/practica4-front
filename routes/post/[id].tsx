...
export const handler: Handlers = {
  ...
  async POST(req, ctx) {
    ...
    try {
      // ERROR: Se estaba usando el método patch, pero la API espera el método post para crear un nuevo comentario
      await axios.post(
...
export default function PostDetail({ data }: PostProps) {
  ...
  // ERROR: Se utilizan el nombre de las variables en español, cuando los nombres de las variables deben ser en inglés
  return (
